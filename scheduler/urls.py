...
urlpatterns = [
    ...
    url(r'^horario/$', views.HorarioFacilView.as_view(), name='horario'),
    url(r'^horario_admin/$', views.HorarioFacilView.as_view(), name='horario_admin'),
    #url(r'^horario/$', views.horario, name='horario'),
    #url(r'^horario_admin/$', views.horario_admin, name='horario_admin'),
    url(r'^horario_vpm/(?P<area>.*)$', views.horario_vpm, name='horario_vpm'),
    url(r'^horarios_vpm/$', views.horarios_vpm, name='horarios_vpm'),
    ...
    url(r'^eventos/inscripciones/$', views.lista_inscritos_eventos, name='lista_inscritos_eventos'),
    url(r'^eventos/lcs_inscripciones/$', views.lista_lcs_inscritos_eventos, name='lista_lcs_inscritos_eventos'),
    ...
    url(r'^feedback_individual/$', views.feedback_individual, name='feedback_individual'),
